...
| **HTML/CSS/JS "vanilla"** (pas de framework, pas de build) | Le site tient en trois fichiers lisibles directement, sans étape de compilation ni dépendances de build à maintenir — proportionné à la taille du projet. |
